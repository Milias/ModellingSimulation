...
int main(int argc, char ** argv)
{
  ...
  if (argc == 1) {
    ...
    if (strcmp(argv[1],"-walk") == 0) {
      ...
      rw.ComputeRandomWalk(1.0, std::atoi(argv[3]));
      rw.SaveWalkData(argv[4]);
    }
  } else if (argc == 6) {
    if (strcmp(argv[1],"-rsquared") == 0) {
      RandomWalk rw(std::atoi(argv[2]));
      rw.ComputeRSquared(1.0, std::atoi(argv[3]), std::atoi(argv[4]));
      rw.SaveRData(argv[5]);
    } else if (strcmp(argv[1],"-pwalk") == 0) {
      RandomWalk rw(std::atoi(argv[2]));
      rw.ComputeRandomWalk(1.0, std::atoi(argv[3]), std::atof(argv[4]));
      rw.SaveWalkData(argv[5]);
    }
  } else if (argc == 7) {
    if (strcmp(argv[1],"-prsquared") == 0) {
       RandomWalk rw(std::atoi(argv[2]));
       rw.ComputeRSquared(1.0, std::atoi(argv[3]), std::atoi(argv[4]), std::atof(argv[5]));
       rw.SaveRData(argv[6]);
     }
  }
}
