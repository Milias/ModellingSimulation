...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.49\textwidth]{{../graphs/coex1}.pdf}
    \includegraphics[width=0.49\textwidth]{{../graphs/coex2}.pdf}
  \end{center}
  \begin{center}
    \includegraphics[width=0.49\textwidth]{{../graphs/far1}.pdf}
    \includegraphics[width=0.49\textwidth]{{../graphs/far2}.pdf}
  \end{center}
  \caption{Several snapshots of the system, near the critical point (top) and far away from it (bottom).}
\end{figure}
